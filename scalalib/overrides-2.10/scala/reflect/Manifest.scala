...
object ManifestFactory {
  ...
  def AnyRef: Manifest[scala.AnyRef] =
  ...
  private object BooleanManifest extends AnyValManifest[scala.Boolean](
          "Boolean") {
  ...
  private object AnyManifest extends PhantomManifest[scala.Any](
          classOf[java.lang.Object], "Any") {
  ...
  private object ObjectManifest extends PhantomManifest[java.lang.Object](
  ...
  private object AnyValManifest extends PhantomManifest[scala.AnyVal](
  ...
  private object NullManifest extends PhantomManifest[scala.Null](
          classOf[scala.runtime.Null$], "Null") {
  ...
  private object NothingManifest extends PhantomManifest[scala.Nothing](
  ...
  private class ClassTypeManifest[T](
    ...
    override def toString =
      (if (prefix.isEmpty) ""
       else prefix.get.toString + "#") +
      (if (erasure.isArray) "Array"
          else erasure.getName) + argString
  }
