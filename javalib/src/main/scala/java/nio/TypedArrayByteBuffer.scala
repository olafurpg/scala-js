...
private [nio] final class TypedArrayByteBuffer private(
    ...
    _initialLimit: Int,
    _readOnly: Boolean) extends ByteBuffer(_typedArray.length, null, -1) {
  ...
  def putChar(value: Char): ByteBuffer = {
    ensureNotReadOnly();
    _dataView.setUint16(getPosAndAdvanceWrite(2), value, !isBigEndian);
    this
  }
  @noinline
  ...
  def putChar(index: Int, value: Char): ByteBuffer = {
    ensureNotReadOnly();
    _dataView.setUint16(validateIndex(index, 2), value, !isBigEndian);
    this
  }
  ...
  def putShort(value: Short): ByteBuffer = {
    ensureNotReadOnly();
    _dataView.setInt16(getPosAndAdvanceWrite(2), value, !isBigEndian);
    this
  }
  @noinline
  ...
  def putShort(index: Int, value: Short): ByteBuffer = {
    ensureNotReadOnly();
    _dataView.setInt16(validateIndex(index, 2), value, !isBigEndian);
    this
  }
  ...
  def putInt(value: Int): ByteBuffer = {
    ensureNotReadOnly();
    _dataView.setInt32(getPosAndAdvanceWrite(4), value, !isBigEndian);
    this
  }
  @noinline
  ...
  def putInt(index: Int, value: Int): ByteBuffer = {
    ensureNotReadOnly();
    _dataView.setInt32(validateIndex(index, 4), value, !isBigEndian);
    this
  }
  ...
  def putLong(value: Long): ByteBuffer = {
    ensureNotReadOnly();
    _dataView.setInt64(getPosAndAdvanceWrite(8), value, !isBigEndian);
    this
  }
  @noinline
  ...
  def putLong(index: Int, value: Long): ByteBuffer = {
    ensureNotReadOnly();
    _dataView.setInt64(validateIndex(index, 8), value, !isBigEndian);
    this
  }
  ...
  def putFloat(value: Float): ByteBuffer = {
    ensureNotReadOnly();
    _dataView.setFloat32(getPosAndAdvanceWrite(4), value, !isBigEndian);
    this
  }
  @noinline
  ...
  def putFloat(index: Int, value: Float): ByteBuffer = {
    ensureNotReadOnly();
    _dataView.setFloat32(validateIndex(index, 4), value, !isBigEndian);
    this
  }
  ...
  def putDouble(value: Double): ByteBuffer = {
    ensureNotReadOnly();
    _dataView.setFloat64(getPosAndAdvanceWrite(8), value, !isBigEndian);
    this
  }
  @noinline
  ...
  def putDouble(index: Int, value: Double): ByteBuffer = {
    ensureNotReadOnly();
    _dataView.setFloat64(validateIndex(index, 8), value, !isBigEndian);
    this
  }
...
private [nio] object TypedArrayByteBuffer {
  ...
  private [nio] implicit object NewTypedArrayByteBuffer extends GenTypedArrayBuffer.NewTypedArrayBuffer[
          ByteBuffer] {
