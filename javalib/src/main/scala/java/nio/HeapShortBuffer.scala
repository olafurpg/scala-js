...
private [nio] final class HeapShortBuffer private(_capacity: Int,
  ...
  @noinline
  def slice(): ShortBuffer = GenHeapBuffer(this).generic_slice()

  @noinline
  def duplicate(): ShortBuffer = GenHeapBuffer(this).generic_duplicate()
  ...
  @noinline
  def compact(): ShortBuffer = GenHeapBuffer(this).generic_compact()
...
private [nio] object HeapShortBuffer {
  ...
  private [nio] implicit object NewHeapShortBuffer extends GenHeapBuffer.NewHeapBuffer[
          ShortBuffer, Short] {
