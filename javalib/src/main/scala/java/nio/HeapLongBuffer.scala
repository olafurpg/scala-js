...
private [nio] final class HeapLongBuffer private(_capacity: Int,
  ...
  @noinline
  def slice(): LongBuffer = GenHeapBuffer(this).generic_slice()

  @noinline
  def duplicate(): LongBuffer = GenHeapBuffer(this).generic_duplicate()
  ...
  @noinline
  def compact(): LongBuffer = GenHeapBuffer(this).generic_compact()
...
private [nio] object HeapLongBuffer {
  ...
  private [nio] implicit object NewHeapLongBuffer extends GenHeapBuffer.NewHeapBuffer[
          LongBuffer, Long] {
