...
private [nio] final class HeapByteBufferCharView private(
  ...
  @noinline
  def slice(): CharBuffer = GenHeapBufferView(this).generic_slice()

  @noinline
  def duplicate(): CharBuffer = GenHeapBufferView(this).generic_duplicate()
  ...
  @noinline
  def compact(): CharBuffer = GenHeapBufferView(this).generic_compact()
...
private [nio] object HeapByteBufferCharView {
  ...
  private [nio] def fromHeapByteBuffer(
      byteBuffer: HeapByteBuffer): CharBuffer =
