...
private [nio] final class HeapByteBufferDoubleView private(
  ...
  @noinline
  def duplicate(): DoubleBuffer = GenHeapBufferView(this).generic_duplicate()
  ...
  @noinline
  def compact(): DoubleBuffer = GenHeapBufferView(this).generic_compact()
...
private [nio] object HeapByteBufferDoubleView {
  ...
  private [nio] implicit object NewHeapByteBufferDoubleView extends GenHeapBufferView.NewHeapBufferView[
          DoubleBuffer] {
