...
private [nio] final class HeapByteBufferShortView private(
  ...
  @noinline
  def duplicate(): ShortBuffer = GenHeapBufferView(this).generic_duplicate()
  ...
  @noinline
  def compact(): ShortBuffer = GenHeapBufferView(this).generic_compact()
...
private [nio] object HeapByteBufferShortView {
  ...
  private [nio] implicit object NewHeapByteBufferShortView extends GenHeapBufferView.NewHeapBufferView[
          ShortBuffer] {
  ...
  private [nio] def fromHeapByteBuffer(
      byteBuffer: HeapByteBuffer): ShortBuffer =
