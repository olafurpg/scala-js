...
private [nio] final class HeapDoubleBuffer private(_capacity: Int,
  ...
  @noinline
  def slice(): DoubleBuffer = GenHeapBuffer(this).generic_slice()

  @noinline
  def duplicate(): DoubleBuffer = GenHeapBuffer(this).generic_duplicate()
  ...
  @noinline
  def compact(): DoubleBuffer = GenHeapBuffer(this).generic_compact()
...
private [nio] object HeapDoubleBuffer {
  ...
  private [nio] implicit object NewHeapDoubleBuffer extends GenHeapBuffer.NewHeapBuffer[
          DoubleBuffer, Double] {
