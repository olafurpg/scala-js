...
private [nio] final class ByteArrayBits(array: Array[Byte],
  ...
  @inline
  private def makeLong(bs: (Byte, Byte, Byte, Byte, Byte, Byte, Byte,
      Byte)): Long =
  ...
  @inline
  private def makeDouble(bs: (Byte, Byte, Byte, Byte, Byte, Byte, Byte,
      Byte)): Double =
  ...
  @inline
  private def unmakeLong(l: Long): (Byte, Byte, Byte, Byte, Byte, Byte, Byte,
      Byte) = {
  ...
  @inline
  private def unmakeDouble(d: Double): (Byte, Byte, Byte, Byte, Byte, Byte,
      Byte, Byte) = unmakeLong(java.lang.Double.doubleToLongBits(d))
  ...
  @inline
  private def load8Bytes(index: Int): (Byte, Byte, Byte, Byte, Byte, Byte,
      Byte, Byte) = {
    val idx = indexMultiplier * index + arrayOffset
    (array(idx),
     array(idx + 1),
