...
private [nio] final class HeapByteBufferIntView private(
  ...
  @noinline
  def duplicate(): IntBuffer = GenHeapBufferView(this).generic_duplicate()
  ...
  @noinline
  def compact(): IntBuffer = GenHeapBufferView(this).generic_compact()
...
private [nio] object HeapByteBufferIntView {
  ...
  private [nio] implicit object NewHeapByteBufferIntView extends GenHeapBufferView.NewHeapBufferView[
          IntBuffer] {
