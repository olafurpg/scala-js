...
object WrappedDictionary {
  ...
  private object Cache {
    val safeHasOwnProperty =
      Dynamic.global.Object.prototype.hasOwnProperty.asInstanceOf[
          ThisFunction1[Dictionary[_], String, Boolean]]
  }
  ...
  type CBF[A] = CanBuildFrom[WrappedDictionary[_], (String, A),
  WrappedDictionary[A]]

  implicit def canBuildFrom[A]: CBF[A] =
    new CBF[A] {

      def apply(from: WrappedDictionary[_]): Builder[(String, A),
          WrappedDictionary[A]] = new WrappedDictionaryBuilder[A]
