...
object Trees {
  ...
  case class BinaryOp(op: BinaryOp.Code, lhs: Tree, rhs: Tree)(
    ...
    import BinaryOp._
    val tpe = (op: @switch) match {
      case === | !== | Num_== | Num_!= | Num_< | Num_<= | Num_> | Num_>= | Long_== | Long_!= | Long_< | Long_<= | Long_> | Long_>= | Boolean_== | Boolean_!= | Boolean_| | Boolean_& =>
        BooleanType
      ...
      case Long_+ | Long_- | Long_* | Long_/ | Long_% | Long_| | Long_& | Long_^ | Long_<< | Long_>>> | Long_>> =>
        LongType
    }
  }
  ...
  case class NewArray(
      tpe: ArrayType, lengths: List[Tree])(implicit val pos: Position)
      extends Tree {
  ...
  object CallHelper {
    ...
    def apply(helper: String, args: Tree *)(
        tpe: Type)(implicit pos: Position): CallHelper = {
   ...
   *  `this` value.
   */
  case class JSSuperBracketSelect(
      cls: ClassType, receiver: Tree, item: Tree)(implicit val pos: Position)
      extends Tree {
    val tpe = AnyType
  }
  ...
  case class JSDelete(prop: Tree)(implicit val pos: Position)
      extends Tree {
    require(prop match {
