...
object JavaLangString {
  val InfoAndTree = {
    ...
    val classDef =
      ClassDef(Ident("T", Some("java.lang.String")),
               ClassKind.HijackedClass,
               Some(Ident("O", Some("java.lang.Object"))),
               List(
                   Ident(
                       "Ljava_io_Serializable", Some("java.io.Serializable")),
               ...
               List(
                   ...
                   MethodDef(
                       ...
                       List(ParamDef(Ident("that", Some("that")),
                                     AnyType,
                                     mutable = false,
                                     rest = false)),
                       BooleanType, {
                   ...
                   MethodDef(static = false,
                             ...
                             IntType, {
                               Apply(This()(ThisType),
                                     Ident("compareTo__T__I",
                                           Some("compareTo__T__I")),
                                     List(AsInstanceOf(
                                         VarRef(Ident("that", Some("that")))(
                                             AnyType),
                                         ThisType)))(IntType)
                   ...
                   MethodDef(
                       ...
                       List(ParamDef(Ident("i", Some("i")),
                                     IntType,
                                     mutable = false,
                                     rest = false)),
                       IntType, {
                         Apply(LoadModule(ClassType("sjsr_RuntimeString$")),
                               Ident("charAt__T__I__C",
                                     Some("charAt__T__I__C")),
                               List(This()(ThisType),
                                    VarRef(Ident("i", Some("i")))(IntType)))(
                             IntType)
                       })(OptimizerHints.empty.withInline(true), None),
         ...
         */
                   MethodDef(static = false,
                             ...
                             List(
                                 ParamDef(Ident("begin", Some("begin")),
                                          IntType,
                                          mutable = false,
                                          rest = false),
                             ...
                             ClassType("jl_CharSequence"), {
                               Apply(
                                   ...
                                   List(This()(ThisType),
                                        VarRef(Ident("begin", Some("begin")))(
                                            IntType),
                                        VarRef(Ident("end", Some("end")))(
                                            IntType)))(ClassType(
                                   "jl_CharSequence"))
                             })(OptimizerHints.empty.withInline(true), None)
