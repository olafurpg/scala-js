...
class MathTestOnJDK8 {
  ...
  def addExact(): Unit = {
    ...
    expectThrows(classOf[ArithmeticException],
                 Math.addExact(Int.MinValue, Int.MinValue))
    ...
    expectThrows(classOf[ArithmeticException],
                 Math.addExact(Int.MaxValue, Int.MaxValue))
    expectThrows(
    ...
    expectThrows(
        classOf[ArithmeticException], Math.addExact(Long.MinValue, -1))
    expectThrows(
        classOf[ArithmeticException], Math.addExact(-1, Long.MinValue))
    expectThrows(classOf[ArithmeticException],
                 Math.addExact(Long.MinValue, Long.MinValue))
    ...
    expectThrows(classOf[ArithmeticException],
                 Math.addExact(Long.MaxValue, Long.MaxValue))
    expectThrows(classOf[ArithmeticException],
                 Math.addExact(4611686018427387904L, 4611686018427387904L))
  }
  ...
  def subtractExact(): Unit = {
    ...
    expectThrows(classOf[ArithmeticException],
                 Math.subtractExact(1073741824, -1073741824))
  ...
  def multiplyExact(): Unit = {
    ...
    expectThrows(
        classOf[ArithmeticException], Math.multiplyExact(1073741824, 2))
    expectThrows(
        classOf[ArithmeticException], Math.multiplyExact(2, 1073741824))
    expectThrows(
        classOf[ArithmeticException], Math.multiplyExact(1073741825, -2))
    expectThrows(
        classOf[ArithmeticException], Math.multiplyExact(-2, 1073741825))
    ...
    assertEquals(
        9223372036854775806L, Math.multiplyExact(2, 4611686018427387903L))
    ...
    expectThrows(
        classOf[ArithmeticException], Math.multiplyExact(-1, Long.MinValue))
    expectThrows(classOf[ArithmeticException],
    ...
    expectThrows(classOf[ArithmeticException],
                 Math.multiplyExact(4611686018427387904L, 2))
    expectThrows(classOf[ArithmeticException],
                 Math.multiplyExact(2, 4611686018427387904L))
    expectThrows(classOf[ArithmeticException],
  ...
  def incrementExact(): Unit = {
    ...
    expectThrows(
        classOf[ArithmeticException], Math.incrementExact(Int.MaxValue))
    expectThrows(
        classOf[ArithmeticException], Math.incrementExact(Long.MaxValue))
  }
  ...
  def decrementExact(): Unit = {
    ...
    expectThrows(
        classOf[ArithmeticException], Math.decrementExact(Int.MinValue))
    expectThrows(
        classOf[ArithmeticException], Math.decrementExact(Long.MinValue))
  }
  ...
  def floorDiv(): Unit = {
    ...
    assertEquals(Long.MinValue, Math.floorDiv(Long.MinValue, -1))
    for (n <- Seq(0L, 1L, -1L, Long.MaxValue, Long.MinValue)) expectThrows(
        classOf[ArithmeticException], Math.floorDiv(n, 0))
  }
}
