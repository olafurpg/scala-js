...
trait SortedMapTest extends MapTest {
  ...
  @Test
  def should_always_be_sorted(): Unit = {}

  @Test
  def should_return_the_firstKey(): Unit = {}

  @Test
  def should_return_the_lastKey(): Unit = {}

  @Test
  def should_return_a_proper_headMap(): Unit = {}

  @Test
  def should_return_a_proper_tailMap(): Unit = {}

  @Test
  def should_return_a_proper_subMap(): Unit = {}
}
