...
class HashtableTest {
  ...
  @Test def put(): Unit = {
    val ht = new ju.Hashtable[Int, Int]
    assertEquals(ht.put(1, 4), null)
    assertEquals(4, ht.put(1, 3))
    assertEquals(3, ht.put(1, 5))
    assertEquals(ht.put(2, 5), null)
    assertEquals(2, ht.size)
  }
  ...
  @Test def remove(): Unit = {
    ...
    ht.put(2, 5)
    ht.put(3, 6)
    assertEquals(ht.remove(0), null)
    assertEquals(4, ht.remove(1))
    assertEquals(ht.remove(1), null)
