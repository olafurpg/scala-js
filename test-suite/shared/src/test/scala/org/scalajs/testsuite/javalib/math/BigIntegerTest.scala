...
class BigIntegerTest {
  @Test
  def `should accept 3 as a Byte Array`(): Unit = {
    val bi = new BigInteger(Array[Byte](3))
    assertEquals(3, bi.intValue())
  }

  @Test
  def `should accept 127 as a Byte Array`(): Unit = {
  ...
  @Test
  def `should intialise both Pos byte arrays arrays the same`(): Unit = {
    val eBytes = Array[Byte](27, -15, 65, 39)
    val eSign = 1
    val exp = new BigInteger(eSign, eBytes)
    val eBytesSignum = Array[Byte](27, -15, 65, 39)
  ...
  @Test
  def `should intialise both Neg byte arrays arrays the same`(): Unit = {
    val eBytes = Array[Byte](27, -15, 65, 39)
    val eSign = -1
    val eRes = Array[Byte](-28, 14, -66, -39)
    val exp = new BigInteger(eSign, eBytes)
