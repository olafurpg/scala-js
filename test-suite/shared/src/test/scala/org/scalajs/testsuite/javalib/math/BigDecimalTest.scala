...
class BigDecimalTest {
  ...
  @Test
  def `should accept 3 as aLong`(): Unit = {
  ...
  @Test
  def `should accept 999999999 as aLong`(): Unit = {
  ...
  @Test
  def `should accept 9999999999 as aLong`(): Unit = {
  ...
  @Test
  def `should accept 3 as a string`(): Unit = {
  ...
  @Test
  def `should accept 99 as a string`(): Unit = {
  ...
  @Test
  def `should accept 999999999 as string`(): Unit = {
  ...
  @Test
  def `should accept 9999999999 as a string`(): Unit = {
  ...
  @Test
  def `should accept -999999999 as sting`(): Unit = {
    val bd = new BigDecimal("-999999999")
    assertEquals(-999999999, bd.intValue())
    assertTrue(bd.longValue == - 999999999L)
  }
  ...
  @Test
  def `should accept 9.9 as a string`(): Unit = {
  ...
  @Test
  def `should accept 3.3 as a double`(): Unit = {
    val d = 3.3
  ...
  @Test
  def `should accept 99.99 as a double`(): Unit = {
    val d = 99.99
    val bd = new BigDecimal(d)
    assertEquals(d, bd.doubleValue(), 0.0)
  }
  ...
  @Test
  def `should accept 9999.9999 as a double`(): Unit = {
  ...
  @Test
  def `should accept 99999999.99999999 as a double`(): Unit = {
  ...
  @Test
  def `should accept 999999999.999999999 as a double`(): Unit = {
  ...
  @Test
  def `should accept 9999999999.9999999999 as a double`(): Unit = {
