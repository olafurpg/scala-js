...
class BigIntegerConstructorsTest {
  ...
  @Test
  def testConstructorStringException1(): Unit = {
  ...
  @Test
  def testConstructorStringException2(): Unit = {
    val value = "   9234853876401"
    val radix = 10
    expectThrows(classOf[NumberFormatException], new BigInteger(value, radix))
  }
  ...
  @Test
  def testConstructorStringException3(): Unit = {
  ...
  @Test
  def testConstructorStringException4(): Unit = {
