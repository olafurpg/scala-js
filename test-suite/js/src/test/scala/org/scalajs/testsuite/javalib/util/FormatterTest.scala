...
Long => JLong, Byte => JByte, Short => JShort, Boolean => JBoolean,
String => JString}
...
object FormatterTest extends JasmineTest {
  ...
  describe("java.util.Formatter") {
    ...
    it("should provide 's' conversion") {
      ...
      expectFC("%-10s", FormattableFlags.LEFT_JUSTIFY, 10, -1)
        .toEqual("foobar")
      expectFC("%#-10.2s",
    ...
    it("should provide 'e' conversion") {
      ...
      expectF("%010e", new JDouble(Double.PositiveInfinity))
        .toEqual("  Infinity")
      expectF("%-10e", new JDouble(Double.PositiveInfinity))
        .toEqual("Infinity  ")
      expectF("%(e", new JDouble(Double.NegativeInfinity))
        .toEqual("(Infinity)")
    ...
    it("should allow positional arguments") {
      ...
      expectF("%2$d %2$d %d", new JInteger(1), new JInteger(2))
        .toEqual("2 2 1")
