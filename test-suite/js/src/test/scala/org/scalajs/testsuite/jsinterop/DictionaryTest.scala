...
object DictionaryTest extends JasmineTest {
  describe("scala.scalajs.js.Dictionary") {
    ...
    unless("rhino").it(
        "should behave as specified when deleting a non-configurable property - #461 - #679") {
      val obj = js.Dictionary.empty[js.Any]
      js.Object.defineProperty(
          obj.asInstanceOf[js.Object],
          "nonconfig",
          js.Dynamic.literal(value = 4, writable = false).asInstanceOf[
  ...
  describe("scala.scalajs.js.JSConverters.JSRichGenMap") {
    ...
    it("should provide toJSDictionary") {
      expect(Map("a" -> 1, "b" -> 2).toJSDictionary)
        .toEqual(js.Dynamic.literal(a = 1, b = 2))
      expect(Map("a" -> "foo", "b" -> "bar").toJSDictionary)
        .toEqual(js.Dynamic.literal(a = "foo", b = "bar"))
    }
  }
}
